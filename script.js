...
let weeklyWeatherEndpoint = 'https://api.openweathermap.org/data/2.5/forecast?units=imperial&appid=' + apiKey;
...
let forthcommingWeather = (data) => {
    city.textContent = data.name + ',' + data.sys.day
}
